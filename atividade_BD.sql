...
INSERT INTO Funcionarios (nome, sobrenome, cargo, idade, tempoServico, salario)
	VALUES
		('José', 'Rafael', 'Programador', 29, 3, 7000),
		('Calleb', 'Mateus', 'Programador', 31, 3, 7000),
		('Vitor', 'Mikael', 'Designer', 18, 1, 3000),
		('Felipe', 'Freire', 'Programador', 19, 3, 7000),
		('Orlando', 'Santos', 'Senior', 32, 5, 8000),
		('Pavon', 'Silva', 'Gerente', 40, 10, 10000),
...
DELETE FROM funcionarios WHERE sobrenome = 'Rafael';
